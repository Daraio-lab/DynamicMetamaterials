function timeVec = importTime(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as column vectors.
%   MODEL = IMPORTFILE(FILENAME) Reads data from text file FILENAME for the
%   default selection.
%
%   MODEL = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   Model = importfile('tek0001CH1.csv',38, 10017);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2020/11/11 17:42:58
